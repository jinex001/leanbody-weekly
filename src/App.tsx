...
const PHASES = [
  { weeks: "1~2주", phase: "FOUNDATION", goal: "패턴 정착 + 체지방 감소 시작", bf: "14.9% → 13.5%", color: "#60A5FA" },
  { weeks: "3~4주", phase: "ACCELERATION", goal: "중량 증가 + 선명도 향상", bf: "13.5% → 12.5%", color: "#34D399" },
  { weeks: "5~6주", phase: "DEFINITION", goal: "어깨/V라인 집중 + 케틀벨 강화", bf: "12.5% → 11.5%", color: "#FBBF24" },
  ...
  return [
    {
      ...
      kettlebell: null,
      exercises: [
        { name: "Dips (가중)", note: "BW+5kg 도전", sets: [{ kg: "BW+5", reps: 10 }, { kg: "BW+5", reps: 10 }, { kg: "BW+5", reps: 8 }, { kg: "BW+5", reps: 8 }] },
        { name: "Flat DB Press", note: "22.5kg 목표", sets: [{ kg: 20, reps: 10 }, { kg: 20, reps: 10 }, { kg: 22.5, reps: 8 }, { kg: 22.5, reps: 8 }] },
    ...
    },
    {
      ...
      kettlebell: null,
      exercises: [
        { name: "Overhead Press", note: "boulder shoulders", sets: [{ kg: 30, reps: 8 }, { kg: 35, reps: 8 }, { kg: 35, reps: 8 }, { kg: 35, reps: 6 }] },
        ...
        { name: "Skull Crusher", note: "", sets: [{ kg: 15, reps: 10 }, { kg: 15, reps: 10 }, { kg: 15, reps: 10 }] },
      ],
    },
    {
    ...
    },
    {
      ...
      exercises: [
        { name: "Bulgarian Split Squat", note: "새로 추가", sets: [{ kg: 20, reps: 10 }, { kg: 20, reps: 10 }, { kg: 20, reps: 10 }] },
        { name: "Leg Curl", note: "30.25kg 기반", sets: [{ kg: 23.5, reps: 12 }, { kg: 30.25, reps: 10 }, { kg: 30.25, reps: 10 }, { kg: 30.25, reps: 10 }] },
      ...
      <div style={{ background: "linear-gradient(180deg, #0D1F3C 0%, #060A0F 100%)", padding: "32px 20px 24px", borderBottom: "1px solid #1F2937" }}>
        <div style={{ maxWidth: 600, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", marginTop: 20, borderRadius: 12, overflow: "hidden", border: "1px solid #1F2937" }}>
            {[["현재 체지방", "14.9%", "#60A5FA"], ["체중", "68kg", "#34D399"], ["목표", "~10%", "#F472B6"], ["기간", "8주", "#FBBF24"]].map((item) => (
